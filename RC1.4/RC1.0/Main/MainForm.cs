...
namespace RC1._0.Main
{
    public partial class MainForm : Form
    {
        ...
        {
            CarInfo.CarInfo carinfo = new CarInfo.CarInfo(addressid);
            carinfo.Show();
        }
        ...
        private void 门店销售统计_Click(object sender, EventArgs e)
        {
            TongJi.StoreTJ storetj = new TongJi.StoreTJ();
            storetj.Show();
        }

        private void 车辆经济统计_Click(object sender, EventArgs e)
        {
            TongJi.CarTJ cartj = new TongJi.CarTJ();
            cartj.Show();
        }

        private void 客户消费统计_Click(object sender, EventArgs e)
        {
            TongJi.ClientTJ clienttj = new TongJi.ClientTJ();
            clienttj.Show();
        }       
    }
}
